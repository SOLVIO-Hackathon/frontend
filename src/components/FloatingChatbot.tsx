        ...
        >
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-2 border border-slate-300 rounded-lg focus:border-green-600 focus:ring-2 focus:ring-green-100 focus:outline-none text-sm text-slate-900"
            />
            <button
              type="submit"
